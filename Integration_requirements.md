...
16. Each team assets shoudl have a __UNIQUE__ identifier, in order to __AVOID NAME CONFLICTS__. Every asset should have  the team acronymous as asset name prefix, including ojects, script, texture, etc.... Example: _ONU_table.fbx, AMU_table.dae, BSU_input.cs_ 
